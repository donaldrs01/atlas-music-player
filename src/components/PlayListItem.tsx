...
const PlayListItem: React.FC<PlayListItemProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`group flex w-full cursor-pointer items-center justify-between p-2 ${isPlaying ? "bg-light-now-playing dark:bg-dark-now-playing font-bold text-white" : "bg-light-listItem hover:bg-light-hover dark:bg-dark-bg dark:hover:bg-dark-hover"}`}
    >
      ...
      <div className="text-light-accent dark:text-dark-accent pr-6 group-hover:text-light-primary dark:group-hover:text-dark-primary">
        <p
          className={`text-sm ${isPlaying ? "text-light-primary dark:text-dark-primary" : "text-light-primary dark:text-dark-primary"} group-hover:text-light-primary dark:group-hover:text-dark-primary`}
        >
          {" "}
